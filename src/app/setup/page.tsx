...
sudo bash setup.sh --domain yourdomain.com`}
            ...
            <ul className="space-y-1.5 text-xs leading-6">
              {[
                ...
                "کپی پروژه به /var/www/naqoli-studio و ساخت فایل .env با کلید امنیتی ورود",
                "نصب وابستگی‌ها و اعمال اسکیما — پنل خام و تمیز (داده نمونه فقط با فلگ --demo)",
            ...
            <div className="overflow-x-auto rounded-xl border border-line">
              <table className="w-full min-w-[420px]">
                <tbody>
                  ...
                  <TRow k="--demo" v="درج داده‌های نمونه برای دمو (پیش‌فرض: پنل خام)" />
